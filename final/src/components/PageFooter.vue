  ...
  <footer class="footer">
    <div class="container footer__container">
      <div class="footer__main">
        <a class="footer__logo logo link" @click.prevent="goto({page:'index'})">
          <img
            src="../assets/Logo.svg"
            alt="Interno Logo"
            width="34"
        ...
        <nav>
          <ul class="nav-list">
            <li class="nav-list__list-item footer__text">
              <a class="link text" @click.prevent="goto({page:'index'})">Home</a>
            </li>
            <li class="nav-list__list-item footer__text">
            ...
            <li class="nav-list__list-item footer__text">
              <a class="link text" @click.prevent="goto({page:'blog'})">Blog</a>
            </li>
          </ul>
        </nav>
      </div>
