<template>
  <div :class="variant">
    <button :class="variant + '__zoom-button'" type="button" @click="onclick">
      <img
        :class="variant + '__image'"
        :src="require('@/assets/images/' + data.img.src)"
        :alt="data.heading"
        :width="data.img.width"
        :height="data.img.height"
      />
      <svg
        :class="variant + '__zoom-icon'"
        width="172"
        height="172"
        viewBox="0 0 172 172"
        fill="none"
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_1418_52"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_1418_52"
              result="shape"
            />
          </filter>
        </defs>
...
.fullscreen {
  ...
  &__zoom-button {
    ...
    width: 100vw;
    height: 100vh;
    background-color: color.adjust($heading-color, $alpha: -0.2);
  }
}
</style>
